---
title: Myria Samples App
description: Typescript application that shows how to interact with the `myria-core-sdk` library
---

## Overview

[Myria Samples App](https://github.com/thisonedev/vault/tree/master/myria-samples-app) is a Typescript application that shows how to interact with the `myria-core-sdk` library. 
...
> [Original repo](https://gitlab.com/myriaworld/myrianet/blockchain/myria-ts-samples)
...
### 2. Enter myria-samples-app directory

```
cd myria-samples-app
```
